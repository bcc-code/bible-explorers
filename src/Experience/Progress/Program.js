...
export default class Program {
  constructor() {
    ...
    instance.currentLocation = () => {
      if (instance.stepType() == 'video') {
        return 'portal';
      } else if (instance.stepType() == 'iris' || instance.stepType() == 'quiz') {
        return 'irisCloseLook';
      } else if (instance.stepType() == 'task') {
        // Games
        if (instance.taskType() == 'cables' || instance.taskType() == 'sorting' || instance.taskType() == 'simon_says' || instance.taskType() == 'flip_cards' || instance.taskType() == 'choose_new_king' || instance.taskType() == 'heart_defense' || instance.taskType() == 'davids_refuge' || instance.taskType() == 'video_with_question' || instance.taskType() == 'labyrinth' || instance.taskType() == 'confirmation_screen') {
          return 'irisCloseLook';
        } else {
  ...
  startTask() {
    if (instance.stepType() == 'video') {
      ...
      if (instance.stepType() == 'iris') {
        instance.getCurrentStepData().message.character == 'glitch' ? instance.camera.updateCameraTo('irisWithOptions', instance.message.show) : instance.message.show();
      } else if (instance.stepType() == 'task') {
    ...
    if (instance.currentCheckpoint == instance.totalCheckpoints) instance.showBibleCards();
  }
  ...
  objectIsClickable() {
    return instance.currentCheckpoint in instance.programData && instance.interactiveObjects().includes(instance.clickedObject);
  }
