...
(function () {
    var indexedDB = window.indexedDB || window.webkitIndexedDB || window.mozIndexedDB || window.OIndexedDB || window.msIndexedDB,
        ...
        dbVersion = 1.0, db, transaction, objStore, getItem, putItem
    ...
    var request = indexedDB.open("bibleExplorersEpisodes", dbVersion),
        ...
        getFile = function (store, name) {
            ...
            getItem = objStore.get(name)
            
            getItem.onsuccess = function() {
                // console.log(getItem.result, store, name, 'getFile')
        ...
        putFileInDb = function (blob, store, name) {
            ...
            objStore = transaction.objectStore(store)
            putItem = objStore.put(blob, name)

            putItem.onsuccess = function() {
                retrieveStoredFile(store, name)
            }
        }
